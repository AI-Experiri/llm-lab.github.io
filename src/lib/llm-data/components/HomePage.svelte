<!-- ABOUTME: Overview page for LLM Data Lab -->
<!-- ABOUTME: Covers why data matters, training stages, and legal considerations -->
...
<div class="space-y-6">
	...
	<!-- Copyright & Legal -->
	<Section title="⚖️ Copyright & Legal Considerations">
		<p class="mb-6 text-[var(--color-muted)] text-[var(--text-small)]">
	...
	<Section title="📈 Data Scaling Insights">
		...
		<ul class="space-y-2 text-[var(--text-small)]">
			<li class="flex items-start gap-3">
				...
				<div>
					...
					<span class="text-[var(--color-muted)]"> — Lectures 13 & 14: Data</span>
				</div>
			</li>
			<li class="flex items-start gap-3">
				...
				<div>
					<a
						href="https://arxiv.org/abs/2406.11794"
						target="_blank"
						rel="noopener noreferrer external"
						class="text-[var(--color-accent)] hover:underline"
					>
					...
					<span class="text-[var(--color-muted)]"> — Penedo et al. (2024)</span>
				</div>
			</li>
			<li class="flex items-start gap-3">
				...
				<div>
					...
					<span class="text-[var(--color-muted)]"> — Li et al. (2024)</span>
				</div>
			</li>
		</ul>
	</Section>
